...
$sql = "SELECT * FROM demande WHERE statut='Accepter' and secteur='hommes' ORDER BY id DESC  ";
$result = $conn->query($sql);

$sql1 = "SELECT * FROM demande WHERE statut='Accepter' and secteur='femmes' ORDER BY id DESC  ";
$result1 = $conn->query($sql1);

$sql2 = "SELECT * FROM demande WHERE statut='Accepter' and secteur='soins' ORDER BY id DESC  ";
$result2 = $conn->query($sql2);

$sql3 = "SELECT * FROM demande WHERE statut='Accepter' and secteur='onglerie' ORDER BY id DESC  ";
$result3 = $conn->query($sql3);

$sql4 = "SELECT * FROM demande WHERE statut='Accepter' and secteur='makeup' ORDER BY id DESC  ";
$result4 = $conn->query($sql4);

$sql5 = "SELECT * FROM demande WHERE statut='Accepter' and secteur='autre' ORDER BY id DESC  ";
               ...
               <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-6 col-sm-12">
                         <div class="home-info">
                              ...
                              <h1>La liste des différentes demande Accepter</h1>
                         </div>
                    </div>
                ...
                <tr>
                    ...
                    <td>
                      <?php if ($row['statut'] !== 'Supprimer') { ?>
                        <a class="btn btn-danger" href="dmdsup.php?id=<?php echo $row['id']; ?>">Annuler</a>
                      <?php } else { ?>
                        <a class="btn btn-danger disabled" href="#">Annuler</a>
                      <?php } ?>
                    </td>
          ...
          $counter = 1;
            while ($row = $result1->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td>
                      <?php if ($row['statut'] !== 'Supprimer') { ?>
                        <a class="btn btn-danger" href="dmdsup.php?id=<?php echo $row['id']; ?>&de=fou">Annuler</a>
                      <?php } else { ?>
                        <a class="btn btn-danger disabled" href="#">Annuler</a>
                      <?php } ?>
                    </td>
