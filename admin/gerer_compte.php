...
include 'redict.php';
include '../config.php';
$sql = "SELECT * FROM users WHERE statu='empl'  ORDER BY id DESC  ";
...
<body>
               ...
               <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-6 col-sm-12">
                         <div class="home-info">
                              ...
                              <h1>Liste des comptes d'Employers (Actifs) </h1>
                         </div>
                    </div>
    ...
    <tbody>
          ...
          $counter = 1;
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-danger" href="gerer_u.php?id=<?php echo $row['id']; ?>&users=supp">Supprimer</a>
                    </td>
                    <td>
                        <a class="btn btn-success" href="modifs.php?id=<?php echo $row['id']; ?>">Modifier</a>
                    </td>
                </tr>
                <?php
                 $counter++;
     ...
     <!-- FOOTER -->
     <a class="btn btn-success" href="compte.php">Compte supprimer</a>
