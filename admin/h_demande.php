...
include 'redict.php';
include '../config.php';
$sql = "SELECT * FROM demande WHERE statut='Terminer' ORDER BY id DESC  ";
...
<body>
               ...
               <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-6 col-sm-12">
                         <div class="home-info">
                              ...
                              <h1>Historique de toute les demandes </h1>
                         </div>
                    </div>
     ...
     <a class="btn btn-success " href="demande.php">Demandes en attente</a>
